...
$openRoutes = [
    'auth.token.create',
    // You can add routes that do not require authorization verification
];
...
return [
    ...
    'laravel' => [
        ...
        /*
         * Authentication mode is true or false.
         */
        'auth_mode' => env('APIDOC_AUTH_MODE', false),

        /*
         * Available when authentication mode is enabled.
         * Set the IP to restrict the whitelist array.
         * List IPs here to ignore auth links.
         */
        'whitelisted' => [
            env('APIDOC_VIEWER_IP', '127.0.0.1'),
        ],

        /*
         * Available when authentication mode is enabled.
         * Specifies the length of time (in minutes) that the document link is valid for authentication.
         * Default is 30 days.
         */
        'ttl' => 43200,
    ],
    ...
    'routes' => [
        ...
        /* API doc other for POST, PUT, PATCH, GET, DELETE ... */
        [
            'match' => [
                'domains' => [
                    '*',
            ...
            'exclude' => array_merge($openRoutes, $multipartRoutes),
            'apply' => [
                'headers' => [
                    'Accept' => 'application/json',
                    'Accept-Language' => 'zh-TW,zh-CN;q=0.8,zh-HK;q=0.5,en-US;q=0.3,en;q=0.2',
     ...
     *
     * Change to use a custom logo path. E.g:
     * 'logo' => 'resources/views/apidoc/logo.png'
     *
